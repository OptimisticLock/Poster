...
install("twbs:bootstrap");                                                   // 91
install("jparker:crypto-core");                                              // 92
install("jparker:crypto-md5");                                               // 93
install("jparker:gravatar");                                                 // 94
install("utilities:avatar");                                                 // 95
install("oauth2");                                                           // 96
install("facebook");                                                         // 97
install("accounts-facebook");                                                // 98
install("http");                                                             // 99
install("oauth1");                                                           // 100
install("twitter");                                                          // 101
install("accounts-twitter");                                                 // 102
install("github");                                                           // 103
install("accounts-github");                                                  // 104
install("summernote:standalone");                                            // 105
